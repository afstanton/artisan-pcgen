...
pub use migration::ABILITY_MIGRATION_SCHEMA;
pub use modify::MODIFY_SCHEMA;
pub use pcc::{
    ABILITY_INCLUDE_SCHEMA, ABILITYCATEGORY_INCLUDE_SCHEMA, ALIGNMENT_INCLUDE_SCHEMA,
    ARMORPROF_INCLUDE_SCHEMA, BIOSET_INCLUDE_SCHEMA, COMPANIONMOD_INCLUDE_SCHEMA,
    DATACONTROL_INCLUDE_SCHEMA, DATATABLE_INCLUDE_SCHEMA, DYNAMIC_INCLUDE_SCHEMA,
    EQUIPMENT_INCLUDE_SCHEMA, EQUIPMOD_INCLUDE_SCHEMA, FEAT_INCLUDE_SCHEMA,
    FORWARDREF_INCLUDE_SCHEMA, GLOBALMODIFIER_INCLUDE_SCHEMA, HIDETYPE_INCLUDE_SCHEMA,
    INFOTEXT_INCLUDE_SCHEMA, ISMATURE_INCLUDE_SCHEMA, LANGUAGE_INCLUDE_SCHEMA,
    LICENSE_INCLUDE_SCHEMA, LSTEXCLUDE_INCLUDE_SCHEMA, PCC_SCHEMA, SAVE_INCLUDE_SCHEMA,
    SHIELDPROF_INCLUDE_SCHEMA, SHOWINMENU_INCLUDE_SCHEMA, SPELL_INCLUDE_SCHEMA, URL_INCLUDE_SCHEMA,
    VARIABLE_INCLUDE_SCHEMA, WEAPONPROF_INCLUDE_SCHEMA,
};
pub use pcg::{
    AGE_SCHEMA, ALLOWDEBT_SCHEMA, AUTORESIZEGEAR_SCHEMA, AUTOSPELLS_SCHEMA, BIRTHDAY_SCHEMA,
    BIRTHPLACE_SCHEMA, CALCEQUIPSET_SCHEMA, CATCHPHRASE_SCHEMA, CHARACTERASSET_SCHEMA,
    CHARACTERBIO_SCHEMA, CHARACTERCOMP_SCHEMA, CHARACTERDESC_SCHEMA, CHARACTERDMNOTES_SCHEMA,
    CHARACTERMAGIC_SCHEMA, CHARACTERNAME_SCHEMA, CITY_SCHEMA, CLASSABILITIESLEVEL_SCHEMA,
    EQUIPNAME_SCHEMA, EQUIPSET_SCHEMA, EXPERIENCE_SCHEMA, EXPERIENCETABLE_SCHEMA, EYECOLOR_SCHEMA,
    FEATPOOL_SCHEMA, HAIRCOLOR_SCHEMA, HAIRSTYLE_SCHEMA, HANDED_SCHEMA, HEIGHT_SCHEMA,
    IGNORECOST_SCHEMA, INTERESTS_SCHEMA, LOADCOMPANIONS_SCHEMA, MONEY_SCHEMA, NOTE_SCHEMA,
    PCG_CLASS_SCHEMA, PCG_DEITY_SCHEMA, PCG_DOMAIN_SCHEMA, PCG_SKILL_SCHEMA, PCGVERSION_SCHEMA,
    PERSONALITYTRAIT1_SCHEMA, PERSONALITYTRAIT2_SCHEMA, PHOBIAS_SCHEMA, PLAYERNAME_SCHEMA,
    POOLPOINTS_SCHEMA, POOLPOINTSAVAIL_SCHEMA, PORTRAIT_SCHEMA, PURCHASEPOINTS_SCHEMA,
    SKILLFILTER_SCHEMA, SKILLSOUTPUTORDER_SCHEMA, SKINCOLOR_SCHEMA, SPEECHPATTERN_SCHEMA,
    SPELLNAME_SCHEMA, SUPPRESSBIOFIELDS_SCHEMA, TABLABEL_SCHEMA, TABNAME_SCHEMA,
    USEHIGHERKNOWN_SCHEMA, USEHIGHERPREPPED_SCHEMA, USERPOOL_SCHEMA, USETEMPMODS_SCHEMA,
    VERSION_SCHEMA, WEIGHT_SCHEMA,
};
pub use race::RACE_SCHEMA;
pub use skill::SKILL_SCHEMA;
pub use spell::SPELL_SCHEMA;
pub use startpack::{
    FUNDS_STARTPACK_SCHEMA, GENDER_STARTPACK_SCHEMA, LANGAUTO_STARTPACK_SCHEMA, STARTPACK_SCHEMA,
    TOTALCOST_STARTPACK_SCHEMA,
};
pub use subclass::SUBCLASS_SCHEMA;
pub use system::{
    ACNAME_SYSTEM_SCHEMA, ACTYPE_SYSTEM_SCHEMA, AGESET_SYSTEM_SCHEMA, ALIGN_SYSTEM_SCHEMA,
    ALIGNMENTFEATURE_SYSTEM_SCHEMA, ALLOWEDMODES_SYSTEM_SCHEMA, ALTHP_SYSTEM_SCHEMA,
    BABATTCYC_SYSTEM_SCHEMA, BABMAXATT_SYSTEM_SCHEMA, BABMINVAL_SYSTEM_SCHEMA,
    BASEDICE_SYSTEM_SCHEMA, BONUSFEATLEVELSTARTINTERVAL_SCHEMA, BONUSSPELLLEVEL_SCHEMA,
    BONUSSTACKS_SCHEMA, BONUSSTATLEVELSTARTINTERVAL_SCHEMA, CHARACTERTYPE_SYSTEM_SCHEMA,
    CLASSTYPE_SYSTEM_SCHEMA, CRSTEPS_SYSTEM_SCHEMA, CRTHRESHOLD_SYSTEM_SCHEMA,
    CURRENCYUNITABBREV_SYSTEM_SCHEMA, DEFAULTDATASET_SYSTEM_SCHEMA, DEFAULTUNITSET_SYSTEM_SCHEMA,
    DEFAULTVARIABLEVALUE_SYSTEM_SCHEMA, DIESIZES_SYSTEM_SCHEMA, DISPLAYORDER_SYSTEM_SCHEMA,
    DOMAINFEATURE_SYSTEM_SCHEMA, ENCUMBRANCE_SYSTEM_SCHEMA, ENDTABLE_SYSTEM_SCHEMA,
    EQSIZEPENALTY_SYSTEM_SCHEMA, EQSLOT_SYSTEM_SCHEMA, GAMEMODEKEY_SYSTEM_SCHEMA,
    HIDDENEQUIPTYPES_SYSTEM_SCHEMA, HIDDENFEATTYPES_SYSTEM_SCHEMA, ICON_SYSTEM_SCHEMA,
    INFOSHEET_SYSTEM_SCHEMA, LEVEL_SYSTEM_SCHEMA, LEVELMSG_SYSTEM_SCHEMA, LOAD_SYSTEM_SCHEMA,
    LOADMULT_SYSTEM_SCHEMA, MAXNONEPICLEVEL_SYSTEM_SCHEMA, MENUENTRY_SYSTEM_SCHEMA,
    METHOD_SYSTEM_SCHEMA, MONSTERROLEDEFAULT_SYSTEM_SCHEMA, MONSTERROLES_SYSTEM_SCHEMA,
    MOVEMENT_SYSTEM_SCHEMA, NAME_SYSTEM_SCHEMA, NUMSLOTS_SYSTEM_SCHEMA, OUTPUTSHEET_SYSTEM_SCHEMA,
    PLUSCOST_SYSTEM_SCHEMA, PREVIEWDIR_SCHEMA, PREVIEWSHEET_SCHEMA, RACE_SYSTEM_SCHEMA,
    RANGEPENALTY_SYSTEM_SCHEMA, RESIZABLEEQUIPTYPE_SYSTEM_SCHEMA, ROLLMETHOD_SYSTEM_SCHEMA,
    SHORTRANGE_SYSTEM_SCHEMA, SIZEADJUSTMENT_SYSTEM_SCHEMA, SIZEMULT_SYSTEM_SCHEMA,
    SKILLCOST_CLASS_SYSTEM_SCHEMA, SKILLCOST_CROSSCLASS_SYSTEM_SCHEMA,
    SKILLCOST_EXCLUSIVE_SYSTEM_SCHEMA, SKILLMULTIPLIER_SYSTEM_SCHEMA,
    SPELLBASECONCENTRATION_SYSTEM_SCHEMA, SPELLBASEDC_SYSTEM_SCHEMA, SPELLRANGE_SYSTEM_SCHEMA,
    SQUARESIZE_SYSTEM_SCHEMA, STARTTABLE_SYSTEM_SCHEMA, STAT_SYSTEM_SCHEMA,
    STATINPUT_SYSTEM_SCHEMA, STATMODSAVE_SYSTEM_SCHEMA, SUBCLASSLEVEL_SYSTEM_SCHEMA,
    SUBSTITUTIONCLASS_SYSTEM_SCHEMA, SUBSTITUTIONLEVEL_SYSTEM_SCHEMA, TAB_SYSTEM_SCHEMA,
    TABLE_SYSTEM_SCHEMA, UNITSET_SYSTEM_SCHEMA, WEAPONCATEGORY_SYSTEM_SCHEMA,
    WEAPONNONPROFPENALTY_SYSTEM_SCHEMA, WEAPONREACH_SYSTEM_SCHEMA, WEAPONTYPE_SYSTEM_SCHEMA,
...
impl GlobalGroup {
    ...
    pub fn token_key_prefixes(self) -> &'static [&'static str] {
        match self {
            ...
            GlobalGroup::Key => &["KEY"],
            GlobalGroup::Desc => &["DESC", "DESC.CLEAR", "TEMPDESC", "DESCISPI", "NAMEISPI"],
    ...
    pub fn matches(self, upper_key: &str) -> bool {
        match self {
            ...
            GlobalGroup::Desc => {
                matches!(
                    upper_key,
                    "DESC" | "DESC.CLEAR" | "TEMPDESC" | "DESCISPI" | "NAMEISPI"
                )
            }
...
impl LineGrammar {
    ...
    pub fn knows_token_key(&self, key: &str) -> bool {
        ...
        if self
            .tokens
            .iter()
            .any(|t| t.key.eq_ignore_ascii_case(&upper))
        {
            return true;
        }
...
static ALL_SCHEMAS: &[&LineGrammar] = &[
    ...
    &system::STATMODSAVE_SYSTEM_SCHEMA,
    &system::ALTHP_SYSTEM_SCHEMA,
    &system::HIDDENEQUIPTYPES_SYSTEM_SCHEMA,
    &system::HIDDENFEATTYPES_SYSTEM_SCHEMA,
    &class::CLASS_SCHEMA,
    ...
    &gear::GEAR_SCHEMA,
    &kit::KIT_SCHEMA,
    &migration::ABILITY_MIGRATION_SCHEMA,
    &modify::MODIFY_SCHEMA,
    &pcg::PCGVERSION_SCHEMA,
    &pcg::PURCHASEPOINTS_SCHEMA,
    &pcg::POOLPOINTS_SCHEMA,
    &pcg::POOLPOINTSAVAIL_SCHEMA,
    &pcg::TABLABEL_SCHEMA,
    &pcg::AUTOSPELLS_SCHEMA,
    &pcg::USEHIGHERKNOWN_SCHEMA,
    &pcg::USEHIGHERPREPPED_SCHEMA,
    &pcg::LOADCOMPANIONS_SCHEMA,
    &pcg::USETEMPMODS_SCHEMA,
    &pcg::SKILLSOUTPUTORDER_SCHEMA,
    &pcg::SKILLFILTER_SCHEMA,
    &pcg::IGNORECOST_SCHEMA,
    &pcg::ALLOWDEBT_SCHEMA,
    &pcg::AUTORESIZEGEAR_SCHEMA,
    &pcg::CHARACTERNAME_SCHEMA,
    &pcg::PLAYERNAME_SCHEMA,
    &pcg::HEIGHT_SCHEMA,
    &pcg::WEIGHT_SCHEMA,
    &pcg::AGE_SCHEMA,
    &pcg::HANDED_SCHEMA,
    // Character bio
    &pcg::TABNAME_SCHEMA,
    &pcg::SKINCOLOR_SCHEMA,
    &pcg::EYECOLOR_SCHEMA,
    &pcg::HAIRCOLOR_SCHEMA,
    &pcg::HAIRSTYLE_SCHEMA,
    &pcg::CITY_SCHEMA,
    &pcg::BIRTHDAY_SCHEMA,
    &pcg::BIRTHPLACE_SCHEMA,
    &pcg::PERSONALITYTRAIT1_SCHEMA,
    &pcg::PERSONALITYTRAIT2_SCHEMA,
    &pcg::SPEECHPATTERN_SCHEMA,
    &pcg::PHOBIAS_SCHEMA,
    &pcg::INTERESTS_SCHEMA,
    &pcg::CATCHPHRASE_SCHEMA,
    &pcg::PORTRAIT_SCHEMA,
    // Character progression
    &pcg::EXPERIENCE_SCHEMA,
    &pcg::EXPERIENCETABLE_SCHEMA,
    &pcg::MONEY_SCHEMA,
    // Character description blocks
    &pcg::CHARACTERBIO_SCHEMA,
    &pcg::CHARACTERDESC_SCHEMA,
    &pcg::CHARACTERCOMP_SCHEMA,
    &pcg::CHARACTERASSET_SCHEMA,
    &pcg::CHARACTERMAGIC_SCHEMA,
    &pcg::CHARACTERDMNOTES_SCHEMA,
    // Misc standalone
    &pcg::VERSION_SCHEMA,
    &pcg::FEATPOOL_SCHEMA,
    ...
    &pcg::CLASSABILITIESLEVEL_SCHEMA,
    &pcg::NOTE_SCHEMA,
    &pcg::SPELLNAME_SCHEMA,
    &pcg::PCG_DEITY_SCHEMA,
    &pcg::PCG_DOMAIN_SCHEMA,
    &pcc::PCC_SCHEMA,
    &pcc::LANGUAGE_INCLUDE_SCHEMA,
    &pcc::VARIABLE_INCLUDE_SCHEMA,
    &pcc::ISMATURE_INCLUDE_SCHEMA,
    ...
    &pcc::GLOBALMODIFIER_INCLUDE_SCHEMA,
